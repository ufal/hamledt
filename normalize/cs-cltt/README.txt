...
size = 1128 sentences according to Lindat
(the UD conversion:
1125 sentences, 36673 surface tokens, 36689 syntactic words)

See the manual for the annotations on the analytical layer:
http://ufal.mff.cuni.cz/pdt2.0/doc/pdt-guide/en/html/ch05.html

ÚFAL paths:
/net/data/treebanks/cs/cltt ... Dan's copy of the published version 1.0, dated 2015-10-18
