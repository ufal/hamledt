Swedish Universal Dependencies / Talbanken
released via LINDAT/CLARIN on 15.1.2015
http://universaldependencies.github.io/docs/sv/overview/introduction.html
http://hdl.handle.net/11234/1-1464

License: CC BY-SA 3.0

training size    = 4303 sentences, 66645 tokens
development size =  504 sentences,  9797 tokens
test size        = 1219 sentences, 20377 tokens
...
Anna Sågvall Hein, Beáta Megyesi, Jens Nilsson, and Filip Salomonsson.

Caveat: Version 1 of the Swedish UD treebank conforms to the UD guidelines in 
all major respects, but there are a number of minor issues that remain to be 
fixed, in particular in the treatment of ellipsis and discontiguous phrases.
